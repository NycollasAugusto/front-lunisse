            ...
            <form>
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            rounded-lg text-dark/50 focus:outline-none focus:ring-2 focus:ring-light"
                            required
                        >
                ...
                <div>
                    ...
                    >
                        ...
                        {durations.map(duration => <option key={duration} value={duration}>{duration}
                            Minutos </option>)}
                    </select>
                </div>
                <div className="flex gap-4">
                    ...
                    <Button type="submit" loading={loading} className="flex-1" disabled={!data.date || data.time} >
                        Agendar sessão
                    </Button>
                </div>
            </form>
